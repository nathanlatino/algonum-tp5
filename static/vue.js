...
/*
 * not type checking this rawMatrix because flow doesn't play well with
...
/* not type checking this rawMatrix because flow doesn't play well with Proxy */
 ...
 *
 * Not type-checking this because this rawMatrix is perf-critical and the cost
...
function model (
  ...
  {
    // inputs with type="rawMatrix" are read only and setting the input's
    // x will throw an error.
    if (tag === 'input' && type === 'rawMatrix') {
      warn$1(
        "<" + (el.tag) + " v-model=\"" + value + "\" type=\"rawMatrix\">:\n" +
...
/**
 * Not type checking this rawMatrix because flow doesn't like attaching
...
/**
 * Not type-checking this rawMatrix because it's mostly vendor code.
 */
